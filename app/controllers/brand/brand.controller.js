...
(function () {
    ...
    angular
        .module('myApp')
        .controller('brandController', ['$scope', '$rootScope', 'Upload', '$timeout','DataService','$state','GeoCoderService',
            function($scope, $rootScope, Upload, $timeout, DataService, $state, GeoCoderService){
                ...
                function getAddress(){
                    return $scope.merchant.address;
                }

                function setPointFromMap(point){
                    $scope.merchant.location = point;
                }

                function finishSetPoint(){
                    GeoCoderService.geocode($scope.merchant.location, function(response){
                        if(response.success){
                            updateSmallMap($scope.merchant.location, response.results.city);
                            $scope.$digest();
                        }else{
