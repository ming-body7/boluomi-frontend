...
$(function(){
	...
	var d = {
		...
		def.done(function(d){
			...
			//图片预加载
			var imgList = ['albumBg.png','light.png','btn_arrow.png','music-icon.png','loading.gif','copyRight.png','indexIcon.png','musicIcon.png','playingBg.png','workingIcon.png','cover.png'];
			//所有图片合并
