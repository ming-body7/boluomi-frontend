...
$(function(){
	var data = [{
				    'content' : '<div class="section sec1"><div class="edit_area"><img class="logo" src="img/listLogo.png" alt="" /><h4 class="BrandInfo"><p>商家特色、相册、套系</p><p>正在紧急开发中，敬请期待...</p></h4><a class="detailBtn" href="tel:18511599224">联系商家</a><i class="moonBg"></i><i class="lightIcon"></i></div><div>'
				}];
